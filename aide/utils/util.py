...
def load_prompt(
    stage: str, phase: str, obfuscate: bool = False, **variables
) -> Dict[str, Any]:
    """
        ...
        if "source" in section:
            ...
            if obfuscate and source_file.startswith("introduction"):
                source_file = source_file.replace(
                    "introduction", "introduction-obfuscate"
                )
            ...
            if file_path.exists():
                if source_file.endswith(".json"):
                    ...
                    nested_content = _load_json_prompt_section(
                        file_path, prompt_dir, **variables
                    )
...
def _load_json_prompt_section(
    json_file: Path, base_dir: Path, **variables
) -> Dict[str, Any]:
    """

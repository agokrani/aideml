...
def download_huggingface_data(dataset_name: str, task_id: str, dataset_kwargs: dict | None = None):
    """Download HuggingFace dataset directly to tasks/{task_id}."""
    from datasets import load_dataset
    
    target_path = f"/data/tasks/{task_id}"
    try:
        dataset = load_dataset(dataset_name, token=os.environ.get("HF_TOKEN", ""), **dataset_kwargs)

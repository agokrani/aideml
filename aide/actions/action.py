...
class Action(BaseModel):
    ...
    def get_tool_message(self):
        ...
        tool_message_func = provider_to_tool_message_func[self.tool_call_metadata["provider"]]
...
class SubmitReview(Action):
    ...
    metric: float | None = Field(description="If the code ran successfully, report the value of the validation metric. Otherwise, leave it null.")
